      ...
      <div className="mt-auto border-t border-zinc-300 dark:border-zinc-800 p-3 shrink-0">
        {accountLoading ? (
          ...
          <div className={collapsed ? "flex flex-col items-center gap-1" : "flex flex-col gap-2"}>
              ...
              {!collapsed && (
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <span className={`text-xs font-semibold ${isPaid ? "text-amber-600 dark:text-amber-400" : "text-zinc-500"}`}>
                      {plan} Plan
                    </span>
                  </div>
                  {usage && (
                    <div className="mt-1 text-[11px] text-zinc-500 dark:text-zinc-400">
                      {usage.used}/{usage.limit} clips used this month
                    </div>
                  )}
                </div>
              )}
            ...
            {collapsed && (
              <span className={`text-[10px] font-semibold flex items-center gap-0.5 ${isPaid ? "text-amber-600 dark:text-amber-400" : "text-zinc-500"}`}>
                {isPaid && <span>★</span>}
                {plan}
              </span>
            )}
